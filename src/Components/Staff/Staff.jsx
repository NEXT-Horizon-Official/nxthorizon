...
function Staff(){
    ...
    "Pietro is a freshman from New Jersey.  He has acheived achieved high distinction in the AMC 8, placing among the top scorers nationally for mathematical reasoning and problem-solving. In addition, he is a two-time top placer in the World Scholar’s Cup, earning recognition at the global level for excellence in debate, collaborative writing, and interdisciplinary knowledge. He also enjoys playing and performing guitar.",
    "Andrew is a freshman from New Jersey. He enjoys coding and has experience in C++, Java, JavaScript, React, Vue, and Python. When he’s not coding, he likes to play basketball, listen to music, and go to cafes. This year, he aims to tackle more complex coding problems and explore machine learning."
];
    return(
        <>
        ...
        <div className="staff-container">
            ...
            <div className="staff-card-container">
                ...
                <StaffCards image={andrewZhaoPicture} name="Andrew Zhao" position="Founder, Vice President" classOf="29" bio={bios[5]} />
