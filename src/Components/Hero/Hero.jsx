    ...
    return(
        ...
        <div className="hero-container">
            ...
            <div className="hero-sub-two">
                <h1 className="hero-text-secondary">Empowering and inspiring the underrepresented to achieve their competetive coding and math goals and developing more oppurtunities in the field of STEM</h1>
            </div>
